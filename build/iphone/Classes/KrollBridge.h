...
@interface FirstStepsObject : KrollCoverageObject {
#else
@interface FirstStepsObject : KrollObject {
#endif
@private
...
extern NSString * FirstSteps$ModuleRequireFormat;
