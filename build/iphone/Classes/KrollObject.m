 ...
 * Copyright (c) 2009-2011 by FirstSteps, Inc. All Rights Reserved.
...
//@interface FirstStepsObject : NSObject
//@end

@interface FirstStepsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FirstStepsObject class]])
		{
			for (NSString *key in [[(FirstStepsObject*)o modules] allKeys])
			{
