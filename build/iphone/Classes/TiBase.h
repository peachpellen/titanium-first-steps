...
// in simulator we redefine to format for FirstSteps Developer console
...
{\
	NSString * exceptionName = [@"org.firststeps." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.firststeps";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIFirstStepsNativeItemNone = -1, 
	UIFirstStepsNativeItemSpinner = -2,
	UIFirstStepsNativeItemProgressBar = -3,
	
	UIFirstStepsNativeItemSlider = -4,
	UIFirstStepsNativeItemSwitch = -5,
	UIFirstStepsNativeItemMultiButton = -6,
	UIFirstStepsNativeItemSegmented = -7,
	
	UIFirstStepsNativeItemTextView = -8,
	UIFirstStepsNativeItemTextField = -9,
	UIFirstStepsNativeItemSearchBar = -10,
	
	UIFirstStepsNativeItemPicker = -11,
	UIFirstStepsNativeItemDatePicker = -12,
	
	UIFirstStepsNativeItemInfoLight = -13,
	UIFirstStepsNativeItemInfoDark = -14,
	
	UIFirstStepsNativeItemDisclosure = -15,
	
	UIFirstStepsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all FirstSteps instances of
