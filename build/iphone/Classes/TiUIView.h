...
/**
 Base class for all FirstSteps views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the FirstSteps view hierarchy (such as wrapped iOS UIViews) was touched.
